...
<body>
    ...
    <script>
        ...
        if (id === "03fd96a234b7369b0eec0bd25abda4bf") {
            return res.status(401).send(`<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="code-box">
        <div class="code-header">
            <div class="code-content">
                <div><span class="comment">-- made by a fucking demon</span></div>
                <div><span class="fn">loadstring</span>(<span class="keyword">game</span>:<span class="fn">HttpGet</span>(<span class="string">"https://luavex.vercel.app/files/v4/loaders/03fd96a234b7369b0eec0bd25abda4bf"</span>))()</div>
            </div>
            <button class="copy-btn" onclick="copyCode()">Copy</button>
        </div>
        <div class="scrollbar-wrap"><span>◀</span><div class="scrollbar-track"></div><span>▶</span></div>
    ...
    <script>
        function copyCode() {
            navigator.clipboard.writeText('-- made by a fucking demon\\nloadstring(game:HttpGet("https://luavex.vercel.app/files/v4/loaders/03fd96a234b7369b0eec0bd25abda4bf"))()')
            const btn = document.querySelector('.copy-btn')
            btn.innerText = 'Copied!'
            setTimeout(() => btn.innerText = 'Copy', 2000)
        }
    ...
    const scriptMap = {
        "03fd96a234b7369b0eec0bd25abda4bf": "aimbot.lua",
